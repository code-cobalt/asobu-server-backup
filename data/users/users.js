//interests: soccer, football, sports, baseball, basketball, tennis, running, hiking, reading, dance, clubbing, food, politics, tech, science, religion, travel, foreign-language, gaming, cooking, drawing, music, magic
...
const users = [
  {
    ...
    password_hash: bcrypt.hashSync('pass', bcrypt.genSaltSync(8)),
    profile_photo:
  ...
  },
  {
    ...
    phone_number: '+8108012345678',
    password_hash: bcrypt.hashSync('pass', bcrypt.genSaltSync(8)),
    profile_photo:
      'data:image/jpeg;base64,',
    interests: ['sports', 'tennis', 'food'],
    exp: 28,
    lvl: 2,
    stats: {
      funny: 4,
  ...
  },
  {
    ...
    phone_number: '+8108087654321',
    password_hash: bcrypt.hashSync('pass', bcrypt.genSaltSync(8)),
    profile_photo:
      'https://media.istockphoto.com/photos/happy-laughing-man-picture-id544358212?k=6&m=544358212&s=612x612&w=0&h=odURMNz2hty8LIfpVahaaUKpGU4vd-UlZx4jy-OAnJA=',
    interests: ['gaming', 'politics', 'tech'],
    exp: 32,
    lvl: 3,
    stats: {
      funny: 5,
  ...
  },
  {
    ...
    interests: ['drawing', 'cooking', 'travel'],
    exp: 23,
    lvl: 2,
    stats: {
      funny: 2,
  ...
  },
  {
    ...
    profile_photo:
      'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
    interests: ['basketball', 'sports', 'reading'],
    exp: 12,
    lvl: 1,
    stats: {
      funny: 2,
